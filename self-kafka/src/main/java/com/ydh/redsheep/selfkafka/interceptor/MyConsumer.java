package com.ydh.redsheep.selfkafka.interceptor;
...
public class MyConsumer {
    public static void main(String[] args) {
        ...
        props.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.16.131.16:9092");
...
//        props.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, "myclient");
        ...
        props.setProperty(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG,
                        "com.ydh.redsheep.selfkafka.interceptor.OneInterceptor" +
                        ",com.ydh.redsheep.selfkafka.interceptor.TwoInterceptor" +
                        ",com.ydh.redsheep.selfkafka.interceptor.ThreeInterceptor"
                );
