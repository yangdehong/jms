package com.ydh.redsheep.selfkafka.offset;
 ...
 * # 创建主题，三个分区，每个分区一个副本
 * kafka-topics.sh --zookeeper 172.16.131.6:2181/kafka --create --topic tp_demo_01 --partitions 3 --replication-factor 1
 * # 将消息生产到主题中
 * kafka-console-producer.sh --broker-list 172.16.131.16:9092 --topic tp_demo_01 < nm.txt
* @author : yangdehong
* @date : 2021/2/8 09:59
*/
public class MyOffsetManager {
    public static void main(String[] args) {
        ...
        configs.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.16.131.16:9092");
